...
package AVR.ATmega168PA is
   ...
   Sig_WDT                  : constant        :=  6;
   Sig_WDT_String           : constant String := "__vector_6";
   --  Timer/Counter2 Compare Match A
   Sig_TIMER2_COMPA         : constant        :=  7;
   Sig_TIMER2_COMPA_String  : constant String := "__vector_7";
   --  Timer/Counter2 Compare Match A
   Sig_TIMER2_COMPB         : constant        :=  8;
   Sig_TIMER2_COMPB_String  : constant String := "__vector_8";
   --  Timer/Counter2 Overflow
   Sig_TIMER2_OVF           : constant        :=  9;
   Sig_TIMER2_OVF_String    : constant String := "__vector_9";
   --  Timer/Counter1 Capture Event
   Sig_TIMER1_CAPT          : constant        := 10;
   Sig_TIMER1_CAPT_String   : constant String := "__vector_10";
   --  Timer/Counter1 Compare Match A
   Sig_TIMER1_COMPA         : constant        := 11;
   Sig_TIMER1_COMPA_String  : constant String := "__vector_11";
   --  Timer/Counter1 Compare Match B
   Sig_TIMER1_COMPB         : constant        := 12;
   Sig_TIMER1_COMPB_String  : constant String := "__vector_12";
   --  Timer/Counter1 Overflow
   Sig_TIMER1_OVF           : constant        := 13;
   Sig_TIMER1_OVF_String    : constant String := "__vector_13";
   ...
   --  USART Rx Complete
   Sig_USART_RX             : constant        := 18;
   Sig_USART_RX_String      : constant String := "__vector_18";
   --  USART, Data Register Empty
   Sig_USART_UDRE           : constant        := 19;
   Sig_USART_UDRE_String    : constant String := "__vector_19";
   --  USART Tx Complete
   Sig_USART_TX             : constant        := 20;
   Sig_USART_TX_String      : constant String := "__vector_20";
   ...
   Sig_TWI                  : constant        := 24;
   Sig_TWI_String           : constant String := "__vector_24";
   --  Store Program Memory Read
   Sig_SPM_Ready            : constant        := 25;
   Sig_SPM_Ready_String     : constant String := "__vector_25";
