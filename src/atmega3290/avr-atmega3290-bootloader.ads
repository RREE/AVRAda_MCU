...
package AVR.ATmega3290.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega3290-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   rww_End    : constant := 16#37ff#;
   nrww_Start : constant := 16#3800#;
