...
package AVR.AT90S8515 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-at90s8515.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   --  interrupts
   --
   Number_Of_Interrupts     : constant := 13;
   ...
   --  UART, Rx Complete
   Sig_UART_RX              : constant        :=  9;
   Sig_UART_RX_String       : constant String := "__vector_9";
   --  UART Data Register Empty
   Sig_UART_UDRE            : constant        := 10;
   Sig_UART_UDRE_String     : constant String := "__vector_10";
   --  UART, Tx Complete
   Sig_UART_TX              : constant        := 11;
   Sig_UART_TX_String       : constant String := "__vector_11";
   --  Analog Comparator
   ...
   --  EEPROM Read/Write Access High Byte bit 0
