...
package AVR.ATmega162 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega162.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   Ext_SRAM_Start_Addr      : constant := 16#500#;
   ...
   Sig_TIMER3_CAPT          : constant        :=  6;
   Sig_TIMER3_CAPT_String   : constant String := "__vector_6";
   --  Timer/Counter3 Compare Match A
   Sig_TIMER3_COMPA         : constant        :=  7;
   Sig_TIMER3_COMPA_String  : constant String := "__vector_7";
   --  Timer/Counter3 Compare Match B
   Sig_TIMER3_COMPB         : constant        :=  8;
   Sig_TIMER3_COMPB_String  : constant String := "__vector_8";
   --  Timer/Counter3 Overflow
   Sig_TIMER3_OVF           : constant        :=  9;
   Sig_TIMER3_OVF_String    : constant String := "__vector_9";
   --  Timer/Counter2 Compare Match
   Sig_TIMER2_COMP          : constant        := 10;
   Sig_TIMER2_COMP_String   : constant String := "__vector_10";
   ...
   Sig_SPI_STC              : constant        := 18;
   Sig_SPI_STC_String       : constant String := "__vector_18";
   --  USART0, Rx Complete
   Sig_USART0_RXC           : constant        := 19;
   Sig_USART0_RXC_String    : constant String := "__vector_19";
   --  USART1, Rx Complete
   Sig_USART1_RXC           : constant        := 20;
   Sig_USART1_RXC_String    : constant String := "__vector_20";
   --  USART0 Data register Empty
   Sig_USART0_UDRE          : constant        := 21;
   Sig_USART0_UDRE_String   : constant String := "__vector_21";
   --  USART1, Data register Empty
   Sig_USART1_UDRE          : constant        := 22;
   Sig_USART1_UDRE_String   : constant String := "__vector_22";
   --  USART0, Tx Complete
   Sig_USART0_TXC           : constant        := 23;
   Sig_USART0_TXC_String    : constant String := "__vector_23";
   --  USART1, Tx Complete
   Sig_USART1_TXC           : constant        := 24;
   Sig_USART1_TXC_String    : constant String := "__vector_24";
   --  EEPROM Ready
   Sig_EE_RDY               : constant        := 25;
   Sig_EE_RDY_String        : constant String := "__vector_25";
   --  Analog Comparator
   Sig_ANA_COMP             : constant        := 26;
   Sig_ANA_COMP_String      : constant String := "__vector_26";
   --  Store Program Memory Read
   Sig_SPM_RDY              : constant        := 27;
   Sig_SPM_RDY_String       : constant String := "__vector_27";
   ...
   FOC3B_Bit                : constant Bit_Number := 2;
   FOC3B_Mask               : constant Unsigned_8 := 16#04#;
   --  Force Output Compare for Channel A
   FOC3A_Bit                : constant Bit_Number := 3;
   FOC3A_Mask               : constant Unsigned_8 := 16#08#;
   ...
   --  Pulse Width Modulator Select Bit 2
   WGM32_Bit                : constant Bit_Number := 3;
   WGM32_Mask               : constant Unsigned_8 := 16#08#;
   --  Pulse Width Modulator Select Bit 3
   ...
   UBRR1H_Addr              : constant Address    := 16#5c#;
   UBRR1H                   : Unsigned_8 ;
   ...
   UCSR1C_Addr              : constant Address    := 16#5c#;
   UCSR1C                   : Unsigned_8 ;
   ...
   --  Register Select
   URSEL1_Bit               : constant Bit_Number := 7;
   URSEL1_Mask              : constant Unsigned_8 := 16#80#;
   ...
   PCIE0_Bit                : constant Bit_Number := 3;
   PCIE0_Mask               : constant Unsigned_8 := 16#08#;
   --  Pin Change Interrupt Enable 1
   PCIE1_Bit                : constant Bit_Number := 4;
   PCIE1_Mask               : constant Unsigned_8 := 16#10#;
   ...
   PCIF0_Bit                : constant Bit_Number := 3;
   PCIF0_Mask               : constant Unsigned_8 := 16#08#;
   --  Pin Change Interrupt Flag 1
   PCIF1_Bit                : constant Bit_Number := 4;
   PCIF1_Mask               : constant Unsigned_8 := 16#10#;
   ...
   TOIE2_Bit                : constant Bit_Number := 2;
   TOIE2_Mask               : constant Unsigned_8 := 16#04#;
   ...
   OCIE2_Bit                : constant Bit_Number := 4;
   OCIE2_Mask               : constant Unsigned_8 := 16#10#;
   ...
   TOV2_Bit                 : constant Bit_Number := 2;
   TOV2_Mask                : constant Unsigned_8 := 16#04#;
   --  Input Capture Flag 1
   ICF1_Bit                 : constant Bit_Number := 3;
   ICF1_Mask                : constant Unsigned_8 := 16#08#;
   --  Output Compare Flag 2
   OCF2_Bit                 : constant Bit_Number := 4;
   OCF2_Mask                : constant Unsigned_8 := 16#10#;
   ...
   SM2_Bit                  : constant Bit_Number := 5;
   SM2_Mask                 : constant Unsigned_8 := 16#20#;
   --  JTAG Interface Disable
   JDT_Bit                  : constant Bit_Number := 7;
   JDT_Mask                 : constant Unsigned_8 := 16#80#;
   ...
   --  External Memory High Mask Bit 0
   XMM0_Bit                 : constant Bit_Number := 3;
   XMM0_Mask                : constant Unsigned_8 := 16#08#;
   --  External Memory High Mask Bit 1
   XMM1_Bit                 : constant Bit_Number := 4;
   XMM1_Mask                : constant Unsigned_8 := 16#10#;
   --  External Memory High Mask Bit 2
   XMM2_Bit                 : constant Bit_Number := 5;
   XMM2_Mask                : constant Unsigned_8 := 16#20#;
   --  External Memory Bus Keeper Enable
   XMBK_Bit                 : constant Bit_Number := 6;
   XMBK_Mask                : constant Unsigned_8 := 16#40#;
   ...
   UBRR0H_Addr              : constant Address    := 16#40#;
   UBRR0H                   : Unsigned_8 ;
   ...
   --  Register Select
   URSEL0_Bit               : constant Bit_Number := 7;
   URSEL0_Mask              : constant Unsigned_8 := 16#80#;

   --  USART Control and Status Register C
   UCSR0C_Addr              : constant Address    := 16#40#;
   UCSR0C                   : Unsigned_8 ;
...
--    UBRR0_Mask               : constant Unsigned_8 := 16#01#;
   ...
   OSCCAL_Addr              : constant Address    := 16#24#;
   OSCCAL                   : Unsigned_8 ;
   ...
   OCDR_Addr                : constant Address    := 16#24#;
   OCDR                     : Unsigned_8 ;
   ...
   --  USART Baud Rate Register Low Byte
   UBRR1L_Addr              : constant Address    := 16#20#;
   UBRR1                    : Unsigned_16;
   ...
   --  USART Baud Rate Register bit 0
   UBRR1L0_Bit              : constant Bit_Number := 0;
   UBRR1L0_Mask             : constant Unsigned_8 := 16#01#;
   --  USART Baud Rate Register bit 1
   UBRR1L1_Bit              : constant Bit_Number := 1;
   UBRR1L1_Mask             : constant Unsigned_8 := 16#02#;
   --  USART Baud Rate Register bit 2
   UBRR1L2_Bit              : constant Bit_Number := 2;
   UBRR1L2_Mask             : constant Unsigned_8 := 16#04#;
   --  USART Baud Rate Register bit 3
   UBRR1L3_Bit              : constant Bit_Number := 3;
   UBRR1L3_Mask             : constant Unsigned_8 := 16#08#;
   --  USART Baud Rate Register bit 4
   UBRR1L4_Bit              : constant Bit_Number := 4;
   UBRR1L4_Mask             : constant Unsigned_8 := 16#10#;
   --  USART Baud Rate Register bit 5
   UBRR1L5_Bit              : constant Bit_Number := 5;
   UBRR1L5_Mask             : constant Unsigned_8 := 16#20#;
   --  USART Baud Rate Register bit 6
   UBRR1L6_Bit              : constant Bit_Number := 6;
   UBRR1L6_Mask             : constant Unsigned_8 := 16#40#;
   --  USART Baud Rate Register bit 7
   UBRR1L7_Bit              : constant Bit_Number := 7;
   UBRR1L7_Mask             : constant Unsigned_8 := 16#80#;
