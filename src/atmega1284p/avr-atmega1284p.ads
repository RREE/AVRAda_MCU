...
package AVR.ATmega1284P is
   ...
   Int_SRAM_Size            : constant := 16#4000#;
   ...
   Sig_TIMER3_OVF           : constant        := 34;
   Sig_TIMER3_OVF_String    : constant String := "__vector_34";
...
--    UBRR1_Mask               : constant Unsigned_8 := 16#02#;
   ...
   PRTIM3_Bit               : constant Bit_Number := 0;
   PRTIM3_Mask              : constant Unsigned_8 := 16#01#;
