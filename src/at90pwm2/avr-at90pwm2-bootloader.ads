...
package AVR.AT90PWM2.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-at90pwm2-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
