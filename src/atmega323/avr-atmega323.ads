...
package AVR.ATmega323 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega323.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   --  USART, Rx Complete
   Sig_USART_RXC            : constant        := 13;
   Sig_USART_RXC_String     : constant String := "__vector_13";
   --  USART Data Register Empty
   Sig_USART_UDRE           : constant        := 14;
   Sig_USART_UDRE_String    : constant String := "__vector_14";
   --  USART, Tx Complete
   Sig_USART_TXC            : constant        := 15;
   Sig_USART_TXC_String     : constant String := "__vector_15";
   ...
   ASRE_Bit                 : constant Bit_Number := 4;
   ASRE_Mask                : constant Unsigned_8 := 16#10#;
   --  Applcaiton Section Busy
   ASB_Bit                  : constant Bit_Number := 6;
   ASB_Mask                 : constant Unsigned_8 := 16#40#;
   ...
   --  Sleep Mode Select
   SM2_Bit                  : constant Bit_Number := 6;
   SM2_Mask                 : constant Unsigned_8 := 16#40#;
   --  Sleep Enable
   SE_Bit                   : constant Bit_Number := 7;
   SE_Mask                  : constant Unsigned_8 := 16#80#;
