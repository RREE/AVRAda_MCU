...
package AVR.ATmega8515 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega8515.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   Ext_SRAM_Start_Addr      : constant := 16#260#;
   ...
   Sig_TIMER1_COMPB         : constant        :=  5;
   Sig_TIMER1_COMPB_String  : constant String := "__vector_5";
   --  Timer/Counter1 Overflow
   Sig_TIMER1_OVF           : constant        :=  6;
   Sig_TIMER1_OVF_String    : constant String := "__vector_6";
   --  Timer/Counter0 Overflow
   Sig_TIMER0_OVF           : constant        :=  7;
   Sig_TIMER0_OVF_String    : constant String := "__vector_7";
   --  Serial Transfer Complete
   Sig_SPI_STC              : constant        :=  8;
   Sig_SPI_STC_String       : constant String := "__vector_8";
   --  USART, Rx Complete
   Sig_USART_RX             : constant        :=  9;
   Sig_USART_RX_String      : constant String := "__vector_9";
   --  USART Data Register Empty
   Sig_USART_UDRE           : constant        := 10;
   Sig_USART_UDRE_String    : constant String := "__vector_10";
   --  USART, Tx Complete
   Sig_USART_TX             : constant        := 11;
   Sig_USART_TX_String      : constant String := "__vector_11";
   --  Analog Comparator
   Sig_ANA_COMP             : constant        := 12;
   Sig_ANA_COMP_String      : constant String := "__vector_12";
   --  External Interrupt Request 2
   Sig_INT2                 : constant        := 13;
   Sig_INT2_String          : constant String := "__vector_13";
   --  Timer 0 Compare Match
   Sig_TIMER0_COMP          : constant        := 14;
   Sig_TIMER0_COMP_String   : constant String := "__vector_14";
   --  EEPROM Ready
   Sig_EE_RDY               : constant        := 15;
   Sig_EE_RDY_String        : constant String := "__vector_15";
   --  Store Program Memory Ready
   Sig_SPM_RDY              : constant        := 16;
   Sig_SPM_RDY_String       : constant String := "__vector_16";
