...
package AVR.AT90PWM316 is
   ...
   PCST2_Bit                : constant Bit_Number := 7;
   PCST2_Mask               : constant Unsigned_8 := 16#80#;
   ...
   PICR1H_Addr              : constant Address    := 16#ef#;
   PICR1H                   : Unsigned_8 ;
   for PICR1H'Address use PICR1H_Addr;
   pragma Volatile (PICR1H);
   PICR1H_Bits              : Bits_In_Byte;
   for PICR1H_Bits'Address use PICR1H_Addr;
   pragma Volatile (PICR1H_Bits);
   PICR1_8_Bit              : constant Bit_Number := 0;
   PICR1_8_Mask             : constant Unsigned_8 := 16#01#;
   PICR1_9_Bit              : constant Bit_Number := 1;
   PICR1_9_Mask             : constant Unsigned_8 := 16#02#;
   PICR1_10_Bit             : constant Bit_Number := 2;
   PICR1_10_Mask            : constant Unsigned_8 := 16#04#;
   PICR1_11_Bit             : constant Bit_Number := 3;
   PICR1_11_Mask            : constant Unsigned_8 := 16#08#;
   --  PSC 1 Capture Software Trigger Bit
   PCST1_Bit                : constant Bit_Number := 7;
   PCST1_Mask               : constant Unsigned_8 := 16#80#;

   --  PSC 1 Input Capture Register Low
   PICR1L_Addr              : constant Address    := 16#ee#;
   PICR1                    : Unsigned_16;
   for PICR1'Address use PICR1L_Addr;
   pragma Volatile (PICR1);
   PICR1L                   : Unsigned_8 ;
   for PICR1L'Address use PICR1L_Addr;
   pragma Volatile (PICR1L);
   PICR1L_Bits              : Bits_In_Byte;
   for PICR1L_Bits'Address use PICR1L_Addr;
   pragma Volatile (PICR1L_Bits);
   PICR1_0_Bit              : constant Bit_Number := 0;
   PICR1_0_Mask             : constant Unsigned_8 := 16#01#;
   PICR1_1_Bit              : constant Bit_Number := 1;
   PICR1_1_Mask             : constant Unsigned_8 := 16#02#;
   PICR1_2_Bit              : constant Bit_Number := 2;
   PICR1_2_Mask             : constant Unsigned_8 := 16#04#;
   PICR1_3_Bit              : constant Bit_Number := 3;
   PICR1_3_Mask             : constant Unsigned_8 := 16#08#;
   PICR1_4_Bit              : constant Bit_Number := 4;
   PICR1_4_Mask             : constant Unsigned_8 := 16#10#;
   PICR1_5_Bit              : constant Bit_Number := 5;
   PICR1_5_Mask             : constant Unsigned_8 := 16#20#;
   PICR1_6_Bit              : constant Bit_Number := 6;
   PICR1_6_Mask             : constant Unsigned_8 := 16#40#;
   PICR1_7_Bit              : constant Bit_Number := 7;
   PICR1_7_Mask             : constant Unsigned_8 := 16#80#;

   --  PSC 1 Input B Control
   PFRC1B_Addr              : constant Address    := 16#ed#;
   PFRC1B                   : Unsigned_8 ;
   for PFRC1B'Address use PFRC1B_Addr;
   pragma Volatile (PFRC1B);
   PFRC1B_Bits              : Bits_In_Byte;
   for PFRC1B_Bits'Address use PFRC1B_Addr;
   pragma Volatile (PFRC1B_Bits);
   --  PSC 1 Retrigger and Fault Mode for Part B
   PRFM1B0_Bit              : constant Bit_Number := 0;
   PRFM1B0_Mask             : constant Unsigned_8 := 16#01#;
   --  PSC 1 Retrigger and Fault Mode for Part B
   PRFM1B1_Bit              : constant Bit_Number := 1;
   PRFM1B1_Mask             : constant Unsigned_8 := 16#02#;
   --  PSC 1 Retrigger and Fault Mode for Part B
   PRFM1B2_Bit              : constant Bit_Number := 2;
   PRFM1B2_Mask             : constant Unsigned_8 := 16#04#;
   --  PSC 1 Retrigger and Fault Mode for Part B
   PRFM1B3_Bit              : constant Bit_Number := 3;
   PRFM1B3_Mask             : constant Unsigned_8 := 16#08#;
   --  PSC 1 Filter Enable on Input Part B
   PFLTE1B_Bit              : constant Bit_Number := 4;
   PFLTE1B_Mask             : constant Unsigned_8 := 16#10#;
   --  PSC 1 Edge Level Selector on Input Part B
   PELEV1B_Bit              : constant Bit_Number := 5;
   PELEV1B_Mask             : constant Unsigned_8 := 16#20#;
   --  PSC 1 Input Select for Part B
   PISEL1B_Bit              : constant Bit_Number := 6;
   PISEL1B_Mask             : constant Unsigned_8 := 16#40#;
   --  PSC 1 Capture Enable Input Part B
   PCAE1B_Bit               : constant Bit_Number := 7;
   PCAE1B_Mask              : constant Unsigned_8 := 16#80#;

   --  PSC 1 Input B Control
   PFRC1A_Addr              : constant Address    := 16#ec#;
   PFRC1A                   : Unsigned_8 ;
   for PFRC1A'Address use PFRC1A_Addr;
   pragma Volatile (PFRC1A);
   PFRC1A_Bits              : Bits_In_Byte;
   for PFRC1A_Bits'Address use PFRC1A_Addr;
   pragma Volatile (PFRC1A_Bits);
   --  PSC 1 Retrigger and Fault Mode for Part A
   PRFM1A0_Bit              : constant Bit_Number := 0;
   PRFM1A0_Mask             : constant Unsigned_8 := 16#01#;
   --  PSC 1 Retrigger and Fault Mode for Part A
   PRFM1A1_Bit              : constant Bit_Number := 1;
   PRFM1A1_Mask             : constant Unsigned_8 := 16#02#;
   --  PSC 1 Retrigger and Fault Mode for Part A
   PRFM1A2_Bit              : constant Bit_Number := 2;
   PRFM1A2_Mask             : constant Unsigned_8 := 16#04#;
   --  PSC 1 Retrigger and Fault Mode for Part A
   PRFM1A3_Bit              : constant Bit_Number := 3;
   PRFM1A3_Mask             : constant Unsigned_8 := 16#08#;
   --  PSC 1 Filter Enable on Input Part A
   PFLTE1A_Bit              : constant Bit_Number := 4;
   PFLTE1A_Mask             : constant Unsigned_8 := 16#10#;
   --  PSC 1 Edge Level Selector on Input Part A
   PELEV1A_Bit              : constant Bit_Number := 5;
   PELEV1A_Mask             : constant Unsigned_8 := 16#20#;
   --  PSC 1 Input Select for Part A
   PISEL1A_Bit              : constant Bit_Number := 6;
   PISEL1A_Mask             : constant Unsigned_8 := 16#40#;
   --  PSC 1 Capture Enable Input Part A
   PCAE1A_Bit               : constant Bit_Number := 7;
   PCAE1A_Mask              : constant Unsigned_8 := 16#80#;

   --  PSC 1 Control Register
   PCTL1_Addr               : constant Address    := 16#eb#;
   PCTL1                    : Unsigned_8 ;
   for PCTL1'Address use PCTL1_Addr;
   pragma Volatile (PCTL1);
   PCTL1_Bits               : Bits_In_Byte;
   for PCTL1_Bits'Address use PCTL1_Addr;
   pragma Volatile (PCTL1_Bits);
   --  PSC 1 Run
   PRUN1_Bit                : constant Bit_Number := 0;
   PRUN1_Mask               : constant Unsigned_8 := 16#01#;
   --  PSC1 Complete Cycle
   PCCYC1_Bit               : constant Bit_Number := 1;
   PCCYC1_Mask              : constant Unsigned_8 := 16#02#;
   --  PSC1 Auto Run
   PARUN1_Bit               : constant Bit_Number := 2;
   PARUN1_Mask              : constant Unsigned_8 := 16#04#;
   --  PSC 1 Asynchronous Output Control A
   PAOC1A_Bit               : constant Bit_Number := 3;
   PAOC1A_Mask              : constant Unsigned_8 := 16#08#;
   --  PSC 1 Asynchronous Output Control B
   PAOC1B_Bit               : constant Bit_Number := 4;
   PAOC1B_Mask              : constant Unsigned_8 := 16#10#;
   --  Balance Flank Width Modulation
   PBFM1_Bit                : constant Bit_Number := 5;
   PBFM1_Mask               : constant Unsigned_8 := 16#20#;
   --  PSC 1 Prescaler Select 0
   PPRE10_Bit               : constant Bit_Number := 6;
   PPRE10_Mask              : constant Unsigned_8 := 16#40#;
   --  PSC 1 Prescaler Select 1
   PPRE11_Bit               : constant Bit_Number := 7;
   PPRE11_Mask              : constant Unsigned_8 := 16#80#;

   --  PSC 1 Configuration Register
   PCNF1_Addr               : constant Address    := 16#ea#;
   PCNF1                    : Unsigned_8 ;
   for PCNF1'Address use PCNF1_Addr;
   pragma Volatile (PCNF1);
   PCNF1_Bits               : Bits_In_Byte;
   for PCNF1_Bits'Address use PCNF1_Addr;
   pragma Volatile (PCNF1_Bits);
   --  PSC 1 Input Clock Select
   PCLKSEL1_Bit             : constant Bit_Number := 1;
   PCLKSEL1_Mask            : constant Unsigned_8 := 16#02#;
   --  PSC 1 Output Polarity
   POP1_Bit                 : constant Bit_Number := 2;
   POP1_Mask                : constant Unsigned_8 := 16#04#;
   --  PSC 1 Mode
   PMODE10_Bit              : constant Bit_Number := 3;
   PMODE10_Mask             : constant Unsigned_8 := 16#08#;
   --  PSC 1 Mode
   PMODE11_Bit              : constant Bit_Number := 4;
   PMODE11_Mask             : constant Unsigned_8 := 16#10#;
   --  PSC 1 Lock
   PLOCK1_Bit               : constant Bit_Number := 5;
   PLOCK1_Mask              : constant Unsigned_8 := 16#20#;
   --  PSC 1 Autolock
   PALOCK1_Bit              : constant Bit_Number := 6;
   PALOCK1_Mask             : constant Unsigned_8 := 16#40#;
   --  PSC 1 Fifty
   PFIFTY1_Bit              : constant Bit_Number := 7;
   PFIFTY1_Mask             : constant Unsigned_8 := 16#80#;

   --  Output Compare RB Register High
   OCR1RBH_Addr             : constant Address    := 16#e9#;
   OCR1RBH                  : Unsigned_8 ;
   for OCR1RBH'Address use OCR1RBH_Addr;
   pragma Volatile (OCR1RBH);
   OCR1RBH_Bits             : Bits_In_Byte;
   for OCR1RBH_Bits'Address use OCR1RBH_Addr;
   pragma Volatile (OCR1RBH_Bits);
   OCR1RB_8_Bit             : constant Bit_Number := 0;
   OCR1RB_8_Mask            : constant Unsigned_8 := 16#01#;
   OCR1RB_9_Bit             : constant Bit_Number := 1;
   OCR1RB_9_Mask            : constant Unsigned_8 := 16#02#;
   OCR1RB_10_Bit            : constant Bit_Number := 2;
   OCR1RB_10_Mask           : constant Unsigned_8 := 16#04#;
   OCR1RB_11_Bit            : constant Bit_Number := 3;
   OCR1RB_11_Mask           : constant Unsigned_8 := 16#08#;
   OCR1RB_12_Bit            : constant Bit_Number := 4;
   OCR1RB_12_Mask           : constant Unsigned_8 := 16#10#;
   OCR1RB_13_Bit            : constant Bit_Number := 5;
   OCR1RB_13_Mask           : constant Unsigned_8 := 16#20#;
   OCR1RB_14_Bit            : constant Bit_Number := 6;
   OCR1RB_14_Mask           : constant Unsigned_8 := 16#40#;
   OCR1RB_15_Bit            : constant Bit_Number := 7;
   OCR1RB_15_Mask           : constant Unsigned_8 := 16#80#;

   --  Output Compare RB Register Low
   OCR1RBL_Addr             : constant Address    := 16#e8#;
   OCR1RB                   : Unsigned_16;
   for OCR1RB'Address use OCR1RBL_Addr;
   pragma Volatile (OCR1RB);
   OCR1RBL                  : Unsigned_8 ;
   for OCR1RBL'Address use OCR1RBL_Addr;
   pragma Volatile (OCR1RBL);
   OCR1RBL_Bits             : Bits_In_Byte;
   for OCR1RBL_Bits'Address use OCR1RBL_Addr;
   pragma Volatile (OCR1RBL_Bits);
   OCR1RB_0_Bit             : constant Bit_Number := 0;
   OCR1RB_0_Mask            : constant Unsigned_8 := 16#01#;
   OCR1RB_1_Bit             : constant Bit_Number := 1;
   OCR1RB_1_Mask            : constant Unsigned_8 := 16#02#;
   OCR1RB_2_Bit             : constant Bit_Number := 2;
   OCR1RB_2_Mask            : constant Unsigned_8 := 16#04#;
   OCR1RB_3_Bit             : constant Bit_Number := 3;
   OCR1RB_3_Mask            : constant Unsigned_8 := 16#08#;
   OCR1RB_4_Bit             : constant Bit_Number := 4;
   OCR1RB_4_Mask            : constant Unsigned_8 := 16#10#;
   OCR1RB_5_Bit             : constant Bit_Number := 5;
   OCR1RB_5_Mask            : constant Unsigned_8 := 16#20#;
   OCR1RB_6_Bit             : constant Bit_Number := 6;
   OCR1RB_6_Mask            : constant Unsigned_8 := 16#40#;
   OCR1RB_7_Bit             : constant Bit_Number := 7;
   OCR1RB_7_Mask            : constant Unsigned_8 := 16#80#;

   --  Output Compare SB Register High
   OCR1SBH_Addr             : constant Address    := 16#e7#;
   OCR1SBH                  : Unsigned_8 ;
   for OCR1SBH'Address use OCR1SBH_Addr;
   pragma Volatile (OCR1SBH);
   OCR1SBH_Bits             : Bits_In_Byte;
   for OCR1SBH_Bits'Address use OCR1SBH_Addr;
   pragma Volatile (OCR1SBH_Bits);
   OCR1SB_8_Bit             : constant Bit_Number := 0;
   OCR1SB_8_Mask            : constant Unsigned_8 := 16#01#;
   OCR1SB_9_Bit             : constant Bit_Number := 1;
   OCR1SB_9_Mask            : constant Unsigned_8 := 16#02#;
   OCR1SB_10_Bit            : constant Bit_Number := 2;
   OCR1SB_10_Mask           : constant Unsigned_8 := 16#04#;
   OCR1SB_11_Bit            : constant Bit_Number := 3;
   OCR1SB_11_Mask           : constant Unsigned_8 := 16#08#;

   --  Output Compare SB Register Low
   OCR1SBL_Addr             : constant Address    := 16#e6#;
   OCR1SB                   : Unsigned_16;
   for OCR1SB'Address use OCR1SBL_Addr;
   pragma Volatile (OCR1SB);
   OCR1SBL                  : Unsigned_8 ;
   for OCR1SBL'Address use OCR1SBL_Addr;
   pragma Volatile (OCR1SBL);
   OCR1SBL_Bits             : Bits_In_Byte;
   for OCR1SBL_Bits'Address use OCR1SBL_Addr;
   pragma Volatile (OCR1SBL_Bits);
   OCR1SB_0_Bit             : constant Bit_Number := 0;
   OCR1SB_0_Mask            : constant Unsigned_8 := 16#01#;
   OCR1SB_1_Bit             : constant Bit_Number := 1;
   OCR1SB_1_Mask            : constant Unsigned_8 := 16#02#;
   OCR1SB_2_Bit             : constant Bit_Number := 2;
   OCR1SB_2_Mask            : constant Unsigned_8 := 16#04#;
   OCR1SB_3_Bit             : constant Bit_Number := 3;
   OCR1SB_3_Mask            : constant Unsigned_8 := 16#08#;
   OCR1SB_4_Bit             : constant Bit_Number := 4;
   OCR1SB_4_Mask            : constant Unsigned_8 := 16#10#;
   OCR1SB_5_Bit             : constant Bit_Number := 5;
   OCR1SB_5_Mask            : constant Unsigned_8 := 16#20#;
   OCR1SB_6_Bit             : constant Bit_Number := 6;
   OCR1SB_6_Mask            : constant Unsigned_8 := 16#40#;
   OCR1SB_7_Bit             : constant Bit_Number := 7;
   OCR1SB_7_Mask            : constant Unsigned_8 := 16#80#;

   --  Output Compare RA Register High
   OCR1RAH_Addr             : constant Address    := 16#e5#;
   OCR1RAH                  : Unsigned_8 ;
   for OCR1RAH'Address use OCR1RAH_Addr;
   pragma Volatile (OCR1RAH);
   OCR1RAH_Bits             : Bits_In_Byte;
   for OCR1RAH_Bits'Address use OCR1RAH_Addr;
   pragma Volatile (OCR1RAH_Bits);
   OCR1RA_8_Bit             : constant Bit_Number := 0;
   OCR1RA_8_Mask            : constant Unsigned_8 := 16#01#;
   OCR1RA_9_Bit             : constant Bit_Number := 1;
   OCR1RA_9_Mask            : constant Unsigned_8 := 16#02#;
   OCR1RA_10_Bit            : constant Bit_Number := 2;
   OCR1RA_10_Mask           : constant Unsigned_8 := 16#04#;
   OCR1RA_11_Bit            : constant Bit_Number := 3;
   OCR1RA_11_Mask           : constant Unsigned_8 := 16#08#;

   --  Output Compare RA Register Low
   OCR1RAL_Addr             : constant Address    := 16#e4#;
   OCR1RA                   : Unsigned_16;
   for OCR1RA'Address use OCR1RAL_Addr;
   pragma Volatile (OCR1RA);
   OCR1RAL                  : Unsigned_8 ;
   for OCR1RAL'Address use OCR1RAL_Addr;
   pragma Volatile (OCR1RAL);
   OCR1RAL_Bits             : Bits_In_Byte;
   for OCR1RAL_Bits'Address use OCR1RAL_Addr;
   pragma Volatile (OCR1RAL_Bits);
   OCR1RA_0_Bit             : constant Bit_Number := 0;
   OCR1RA_0_Mask            : constant Unsigned_8 := 16#01#;
   OCR1RA_1_Bit             : constant Bit_Number := 1;
   OCR1RA_1_Mask            : constant Unsigned_8 := 16#02#;
   OCR1RA_2_Bit             : constant Bit_Number := 2;
   OCR1RA_2_Mask            : constant Unsigned_8 := 16#04#;
   OCR1RA_3_Bit             : constant Bit_Number := 3;
   OCR1RA_3_Mask            : constant Unsigned_8 := 16#08#;
   OCR1RA_4_Bit             : constant Bit_Number := 4;
   OCR1RA_4_Mask            : constant Unsigned_8 := 16#10#;
   OCR1RA_5_Bit             : constant Bit_Number := 5;
   OCR1RA_5_Mask            : constant Unsigned_8 := 16#20#;
   OCR1RA_6_Bit             : constant Bit_Number := 6;
   OCR1RA_6_Mask            : constant Unsigned_8 := 16#40#;
   OCR1RA_7_Bit             : constant Bit_Number := 7;
   OCR1RA_7_Mask            : constant Unsigned_8 := 16#80#;

   --  Output Compare SA Register High
   OCR1SAH_Addr             : constant Address    := 16#e3#;
   OCR1SAH                  : Unsigned_8 ;
   for OCR1SAH'Address use OCR1SAH_Addr;
   pragma Volatile (OCR1SAH);
   OCR1SAH_Bits             : Bits_In_Byte;
   for OCR1SAH_Bits'Address use OCR1SAH_Addr;
   pragma Volatile (OCR1SAH_Bits);
   OCR1SA_8_Bit             : constant Bit_Number := 0;
   OCR1SA_8_Mask            : constant Unsigned_8 := 16#01#;
   OCR1SA_9_Bit             : constant Bit_Number := 1;
   OCR1SA_9_Mask            : constant Unsigned_8 := 16#02#;
   OCR1SA_10_Bit            : constant Bit_Number := 2;
   OCR1SA_10_Mask           : constant Unsigned_8 := 16#04#;
   OCR1SA_11_Bit            : constant Bit_Number := 3;
   OCR1SA_11_Mask           : constant Unsigned_8 := 16#08#;

   --  Output Compare SA Register Low
   OCR1SAL_Addr             : constant Address    := 16#e2#;
   OCR1SA                   : Unsigned_16;
   for OCR1SA'Address use OCR1SAL_Addr;
   pragma Volatile (OCR1SA);
   OCR1SAL                  : Unsigned_8 ;
   for OCR1SAL'Address use OCR1SAL_Addr;
   pragma Volatile (OCR1SAL);
   OCR1SAL_Bits             : Bits_In_Byte;
   for OCR1SAL_Bits'Address use OCR1SAL_Addr;
   pragma Volatile (OCR1SAL_Bits);
   OCR1SA_0_Bit             : constant Bit_Number := 0;
   OCR1SA_0_Mask            : constant Unsigned_8 := 16#01#;
   OCR1SA_1_Bit             : constant Bit_Number := 1;
   OCR1SA_1_Mask            : constant Unsigned_8 := 16#02#;
   OCR1SA_2_Bit             : constant Bit_Number := 2;
   OCR1SA_2_Mask            : constant Unsigned_8 := 16#04#;
   OCR1SA_3_Bit             : constant Bit_Number := 3;
   OCR1SA_3_Mask            : constant Unsigned_8 := 16#08#;
   OCR1SA_4_Bit             : constant Bit_Number := 4;
   OCR1SA_4_Mask            : constant Unsigned_8 := 16#10#;
   OCR1SA_5_Bit             : constant Bit_Number := 5;
   OCR1SA_5_Mask            : constant Unsigned_8 := 16#20#;
   OCR1SA_6_Bit             : constant Bit_Number := 6;
   OCR1SA_6_Mask            : constant Unsigned_8 := 16#40#;
   OCR1SA_7_Bit             : constant Bit_Number := 7;
   OCR1SA_7_Mask            : constant Unsigned_8 := 16#80#;

   --  PSC1 Synchro and Output Configuration
   PSOC1_Addr               : constant Address    := 16#e0#;
   PSOC1                    : Unsigned_8 ;
   for PSOC1'Address use PSOC1_Addr;
   pragma Volatile (PSOC1);
   PSOC1_Bits               : Bits_In_Byte;
   for PSOC1_Bits'Address use PSOC1_Addr;
   pragma Volatile (PSOC1_Bits);
   --  PSCOUT10 Output Enable
   POEN1A_Bit               : constant Bit_Number := 0;
   POEN1A_Mask              : constant Unsigned_8 := 16#01#;
   --  PSCOUT11 Output Enable
   POEN1B_Bit               : constant Bit_Number := 2;
   POEN1B_Mask              : constant Unsigned_8 := 16#04#;
   --  Synchronization Out for ADC Selection
   PSYNC1_0_Bit             : constant Bit_Number := 4;
   PSYNC1_0_Mask            : constant Unsigned_8 := 16#10#;
   --  Synchronization Out for ADC Selection
   PSYNC1_1_Bit             : constant Bit_Number := 5;
   PSYNC1_1_Mask            : constant Unsigned_8 := 16#20#;
   ...
   PCST0_Bit                : constant Bit_Number := 7;
   PCST0_Mask               : constant Unsigned_8 := 16#80#;
   ...
   POAC2A_Bit               : constant Bit_Number := 6;
   POAC2A_Mask              : constant Unsigned_8 := 16#40#;
   --  PSC 2 Output A Activity
   POAC2B_Bit               : constant Bit_Number := 7;
   POAC2B_Mask              : constant Unsigned_8 := 16#80#;
   ...
   --  End of Cycle Interrupt Enable
   PEOPE1_Bit               : constant Bit_Number := 0;
   PEOPE1_Mask              : constant Unsigned_8 := 16#01#;
   --  External Event A Interrupt Enable
   PEVE1A_Bit               : constant Bit_Number := 3;
   PEVE1A_Mask              : constant Unsigned_8 := 16#08#;
   --  External Event B Interrupt Enable
   PEVE1B_Bit               : constant Bit_Number := 4;
   PEVE1B_Mask              : constant Unsigned_8 := 16#10#;
   --  PSC 1 Synchro Error Interrupt Enable
   PSEIE1_Bit               : constant Bit_Number := 5;
   PSEIE1_Mask              : constant Unsigned_8 := 16#20#;
   ...
   PEOP1_Bit                : constant Bit_Number := 0;
   PEOP1_Mask               : constant Unsigned_8 := 16#01#;
   --  Ramp Number
   PRN10_Bit                : constant Bit_Number := 1;
   PRN10_Mask               : constant Unsigned_8 := 16#02#;
   --  Ramp Number
   PRN11_Bit                : constant Bit_Number := 2;
   PRN11_Mask               : constant Unsigned_8 := 16#04#;
   --  External Event A Interrupt
   PEV1A_Bit                : constant Bit_Number := 3;
   PEV1A_Mask               : constant Unsigned_8 := 16#08#;
   --  External Event B Interrupt
   PEV1B_Bit                : constant Bit_Number := 4;
   PEV1B_Mask               : constant Unsigned_8 := 16#10#;
   --  PSC 1 Synchro Error Interrupt
   PSEI1_Bit                : constant Bit_Number := 5;
   PSEI1_Mask               : constant Unsigned_8 := 16#20#;
   --  PSC 1 Output A Activity
   POAC1A_Bit               : constant Bit_Number := 6;
   POAC1A_Mask              : constant Unsigned_8 := 16#40#;
   --  PSC 1 Output B Activity
   POAC1B_Bit               : constant Bit_Number := 7;
   POAC1B_Mask              : constant Unsigned_8 := 16#80#;
   ...
   POAC0A_Bit               : constant Bit_Number := 6;
   POAC0A_Mask              : constant Unsigned_8 := 16#40#;
   --  PSC 0 Output A Activity
   POAC0B_Bit               : constant Bit_Number := 7;
   POAC0B_Mask              : constant Unsigned_8 := 16#80#;
