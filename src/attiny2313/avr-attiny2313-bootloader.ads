...
package AVR.ATtiny2313.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-attiny2313-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
