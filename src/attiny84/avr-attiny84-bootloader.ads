...
package AVR.ATtiny84.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-attiny84-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
