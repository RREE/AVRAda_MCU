...
package AVR.ATtiny861.Bootloader is
   pragma Pure (AVR.ATtiny861.Bootloader);

   CVS_Version : constant String := "$Id: avr-attiny861-bootloader.ads 488 2006-01-06 15:43:34Z berndtrog $";
