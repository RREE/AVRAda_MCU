...
package AVR.ATmega8 is
   ...
   CVS_Version : constant String := "$Id: avr-atmega8.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   Sig_SPM_RDY              : constant        := 18;
   Sig_SPM_RDY_String       : constant String := "__vector_18";
   ...
   --  ADC High Speed Mode
   ADHSM_Bit                : constant Bit_Number := 4;
   ADHSM_Mask               : constant Unsigned_8 := 16#10#;
