...
package AVR.AT90USB82.Bootloader is
   pragma Preelaborate;
   ...
   rww_End    : constant := 16#07ff#;
   nrww_Start : constant := 16#0800#;
   ...
   Boot_Info : constant Boot_Info_Array :=
     ( 1 => (Pages => 4, Start => 16#F00#) ,
       2 => (Pages => 8, Start => 16#E00#) ,
       3 => (Pages => 16, Start => 16#C00#) ,
       4 => (Pages => 32, Start => 16#800#) );
   pragma Style_Checks (On);

end AVR.AT90USB82.Bootloader;
