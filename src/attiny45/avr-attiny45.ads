...
package AVR.ATtiny45 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-attiny45.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   --  BOD Sleep Enable
   BODSE_Bit                : constant Bit_Number := 2;
   BODSE_Mask               : constant Unsigned_8 := 16#04#;
   ...
   --  BOD Sleep
   BODS_Bit                 : constant Bit_Number := 7;
   BODS_Mask                : constant Unsigned_8 := 16#80#;
