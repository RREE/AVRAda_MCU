...
package AVR.ATmega324PA is
   ...
   --  USART1 RX complete
   Sig_USART1_RX            : constant        := 28;
   Sig_USART1_RX_String     : constant String := "__vector_28";
   --  USART1 Data Register Empty
   Sig_USART1_UDRE          : constant        := 29;
   Sig_USART1_UDRE_String   : constant String := "__vector_29";
   --  USART1 TX complete
   Sig_USART1_TX            : constant        := 30;
   Sig_USART1_TX_String     : constant String := "__vector_30";
...
--    UBRR1_Mask               : constant Unsigned_8 := 16#02#;
   ...
   PRUSART1_Bit             : constant Bit_Number := 4;
   PRUSART1_Mask            : constant Unsigned_8 := 16#10#;
   ...
   --  SPI Data Register
   SPDR0_Addr               : constant Address    := 16#4e#;
   SPDR0                    : Unsigned_8 ;
   for SPDR0'Address use SPDR0_Addr;
   pragma Volatile (SPDR0);
   SPDR0_Bits               : Bits_In_Byte;
   for SPDR0_Bits'Address use SPDR0_Addr;
   pragma Volatile (SPDR0_Bits);
   --  SPI Data Register bit 0
   SPDRB0_Bit               : constant Bit_Number := 0;
   SPDRB0_Mask              : constant Unsigned_8 := 16#01#;
   --  SPI Data Register bit 1
   SPDRB1_Bit               : constant Bit_Number := 1;
   SPDRB1_Mask              : constant Unsigned_8 := 16#02#;
   --  SPI Data Register bit 2
   SPDRB2_Bit               : constant Bit_Number := 2;
   SPDRB2_Mask              : constant Unsigned_8 := 16#04#;
   --  SPI Data Register bit 3
   SPDRB3_Bit               : constant Bit_Number := 3;
   SPDRB3_Mask              : constant Unsigned_8 := 16#08#;
   --  SPI Data Register bit 4
   SPDRB4_Bit               : constant Bit_Number := 4;
   SPDRB4_Mask              : constant Unsigned_8 := 16#10#;
   --  SPI Data Register bit 5
   SPDRB5_Bit               : constant Bit_Number := 5;
   SPDRB5_Mask              : constant Unsigned_8 := 16#20#;
   --  SPI Data Register bit 6
   SPDRB6_Bit               : constant Bit_Number := 6;
   SPDRB6_Mask              : constant Unsigned_8 := 16#40#;
   --  SPI Data Register bit 7
   SPDRB7_Bit               : constant Bit_Number := 7;
   SPDRB7_Mask              : constant Unsigned_8 := 16#80#;

   --  SPI Status Register
   SPSR0_Addr               : constant Address    := 16#4d#;
   SPSR0                    : Unsigned_8 ;
   for SPSR0'Address use SPSR0_Addr;
   pragma Volatile (SPSR0);
   SPSR0_Bits               : Bits_In_Byte;
   for SPSR0_Bits'Address use SPSR0_Addr;
   pragma Volatile (SPSR0_Bits);
   --  Double SPI Speed Bit
   SPI2X0_Bit               : constant Bit_Number := 0;
   SPI2X0_Mask              : constant Unsigned_8 := 16#01#;
   --  Write Collision Flag
   WCOL0_Bit                : constant Bit_Number := 6;
   WCOL0_Mask               : constant Unsigned_8 := 16#40#;
   --  SPI Interrupt Flag
   SPIF0_Bit                : constant Bit_Number := 7;
   SPIF0_Mask               : constant Unsigned_8 := 16#80#;

   --  SPI Control Register
   SPCR0_Addr               : constant Address    := 16#4c#;
   SPCR0                    : Unsigned_8 ;
   for SPCR0'Address use SPCR0_Addr;
   pragma Volatile (SPCR0);
   SPCR0_Bits               : Bits_In_Byte;
   for SPCR0_Bits'Address use SPCR0_Addr;
   pragma Volatile (SPCR0_Bits);
   --  SPI Clock Rate Select 0
   SPR00_Bit                : constant Bit_Number := 0;
   SPR00_Mask               : constant Unsigned_8 := 16#01#;
   --  SPI Clock Rate Select 1
   SPR10_Bit                : constant Bit_Number := 1;
   SPR10_Mask               : constant Unsigned_8 := 16#02#;
   --  Clock Phase
   CPHA0_Bit                : constant Bit_Number := 2;
   CPHA0_Mask               : constant Unsigned_8 := 16#04#;
   --  Clock polarity
   CPOL0_Bit                : constant Bit_Number := 3;
   CPOL0_Mask               : constant Unsigned_8 := 16#08#;
   --  Master/Slave Select
   MSTR0_Bit                : constant Bit_Number := 4;
   MSTR0_Mask               : constant Unsigned_8 := 16#10#;
   --  Data Order
   DORD0_Bit                : constant Bit_Number := 5;
   DORD0_Mask               : constant Unsigned_8 := 16#20#;
   --  SPI Enable
   SPE0_Bit                 : constant Bit_Number := 6;
   SPE0_Mask                : constant Unsigned_8 := 16#40#;
   --  SPI Interrupt Enable
   SPIE0_Bit                : constant Bit_Number := 7;
   SPIE0_Mask               : constant Unsigned_8 := 16#80#;
