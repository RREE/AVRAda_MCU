...
package AVR.ATtiny48 is
   ...
   --  interrupts
   --
   Number_Of_Interrupts     : constant := 20;
   ...
   Sig_PCINT0               : constant        :=  3;
   Sig_PCINT0_String        : constant String := "__vector_3";
   --  Pin Change Interrupt Request 1
   Sig_PCINT1               : constant        :=  4;
   Sig_PCINT1_String        : constant String := "__vector_4";
   --  Pin Change Interrupt Request 2
   Sig_PCINT2               : constant        :=  5;
   Sig_PCINT2_String        : constant String := "__vector_5";
   --  Pin Change Interrupt Request 3
   Sig_PCINT3               : constant        :=  6;
   Sig_PCINT3_String        : constant String := "__vector_6";
   --  Watchdog Time-out Interrupt
   Sig_WDT                  : constant        :=  7;
   Sig_WDT_String           : constant String := "__vector_7";
   --  Timer/Counter1 Capture Event
   Sig_TIMER1_CAPT          : constant        :=  8;
   Sig_TIMER1_CAPT_String   : constant String := "__vector_8";
   --  Timer/Counter1 Compare Match A
   Sig_TIMER1_COMPA         : constant        :=  9;
   Sig_TIMER1_COMPA_String  : constant String := "__vector_9";
   --  Timer/Counter1 Compare Match B
   Sig_TIMER1_COMPB         : constant        := 10;
   Sig_TIMER1_COMPB_String  : constant String := "__vector_10";
   --  Timer/Counter1 Overflow
   Sig_TIMER1_OVF           : constant        := 11;
   Sig_TIMER1_OVF_String    : constant String := "__vector_11";
   --  TimerCounter0 Compare Match A
   Sig_TIMER0_COMPA         : constant        := 12;
   Sig_TIMER0_COMPA_String  : constant String := "__vector_12";
   --  TimerCounter0 Compare Match B
   Sig_TIMER0_COMPB         : constant        := 13;
   Sig_TIMER0_COMPB_String  : constant String := "__vector_13";
   --  Timer/Couner0 Overflow
   Sig_TIMER0_OVF           : constant        := 14;
   Sig_TIMER0_OVF_String    : constant String := "__vector_14";
   --  SPI Serial Transfer Complete
   Sig_SPI_STC              : constant        := 15;
   Sig_SPI_STC_String       : constant String := "__vector_15";
   --  ADC Conversion Complete
   Sig_ADC                  : constant        := 16;
   Sig_ADC_String           : constant String := "__vector_16";
   --  EEPROM Ready
   Sig_EE_RDY               : constant        := 17;
   Sig_EE_RDY_String        : constant String := "__vector_17";
   --  Analog Comparator
   Sig_ANA_COMP             : constant        := 18;
   Sig_ANA_COMP_String      : constant String := "__vector_18";
   --  Two-wire Serial Interface
   Sig_TWI                  : constant        := 19;
   Sig_TWI_String           : constant String := "__vector_19";
   ...
   --  TWHSR
   TWHSR_Addr               : constant Address    := 16#be#;
   TWHSR                    : Unsigned_8 ;
   for TWHSR'Address use TWHSR_Addr;
   pragma Volatile (TWHSR);
   TWHSR_Bits               : Bits_In_Byte;
   for TWHSR_Bits'Address use TWHSR_Addr;
   pragma Volatile (TWHSR_Bits);
   TWIHS_Bit                : constant Bit_Number := 0;
   TWIHS_Mask               : constant Unsigned_8 := 16#01#;
   ...
   AREFD_Bit                : constant Bit_Number := 2;
   AREFD_Mask               : constant Unsigned_8 := 16#04#;
   ...
   PCMSK3_Addr              : constant Address    := 16#6a#;
   PCMSK3                   : Unsigned_8 ;
   ...
   SELFPRGEN_Bit            : constant Bit_Number := 0;
   SELFPRGEN_Mask           : constant Unsigned_8 := 16#01#;
   --  Page Erase
   ...
   TCCR0A_Addr              : constant Address    := 16#45#;
   TCCR0A                   : Unsigned_8 ;
   ...
   PORTCR_Addr              : constant Address    := 16#32#;
   PORTCR                   : Unsigned_8 ;
   ...
   PUDA_Bit                 : constant Bit_Number := 0;
   PUDA_Mask                : constant Unsigned_8 := 16#01#;
   PUDB_Bit                 : constant Bit_Number := 1;
   PUDB_Mask                : constant Unsigned_8 := 16#02#;
   PUDC_Bit                 : constant Bit_Number := 2;
   PUDC_Mask                : constant Unsigned_8 := 16#04#;
   PUDD_Bit                 : constant Bit_Number := 3;
   PUDD_Mask                : constant Unsigned_8 := 16#08#;
   BBMA_Bit                 : constant Bit_Number := 4;
   BBMA_Mask                : constant Unsigned_8 := 16#10#;
   BBMB_Bit                 : constant Bit_Number := 5;
   BBMB_Mask                : constant Unsigned_8 := 16#20#;
   BBMC_Bit                 : constant Bit_Number := 6;
   BBMC_Mask                : constant Unsigned_8 := 16#40#;
   BBMD_Bit                 : constant Bit_Number := 7;
   BBMD_Mask                : constant Unsigned_8 := 16#80#;

   --  Port A Data Register
   PORTA_Addr               : constant Address    := 16#2e#;
   PORTA                    : Unsigned_8 ;
   ...
   DDRA_Addr                : constant Address    := 16#2d#;
   DDRA                     : Unsigned_8 ;
   ...
   --  Port A Input Pins
   PINA_Addr                : constant Address    := 16#2c#;
   PINA                     : Unsigned_8 ;
