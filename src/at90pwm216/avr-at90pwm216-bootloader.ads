...
package AVR.AT90PWM216.Bootloader is
   pragma Preelaborate;
   ...
   rww_End    : constant := 16#17ff#;
   nrww_Start : constant := 16#1800#;
   ...
   Boot_Info : constant Boot_Info_Array :=
     ( 1 => (Pages => 4, Start => 16#1F00#) ,
       2 => (Pages => 8, Start => 16#1E00#) ,
       3 => (Pages => 16, Start => 16#1C00#) ,
       4 => (Pages => 32, Start => 16#1800#) );
   pragma Style_Checks (On);

end AVR.AT90PWM216.Bootloader;
