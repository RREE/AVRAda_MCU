...
package AVR.AT90CAN64 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-at90can64.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
...
--    UBRR1_Mask               : constant Unsigned_8 := 16#02#;
   ...
   --  EEPROM Read/Write Access High Byte - Only bit 10..8 are used in AT90CAN64 - Only bit 9..8 are used in AT90CAN32
   ...
   --  EEPROM Read/Write Access Bit 10 - Not used in AT90CAN32.
   EEAR10_Bit               : constant Bit_Number := 2;
   EEAR10_Mask              : constant Unsigned_8 := 16#04#;
   --  EEPROM Read/Write Access Bit 11 - Not used in AT90CAN64 and
   --    AT90CAN32.
