...
package AVR.ATmega8535 is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega8535.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   --  USART, RX Complete
   Sig_USART_RX             : constant        := 11;
   Sig_USART_RX_String      : constant String := "__vector_11";
   --  USART Data Register Empty
   Sig_USART_UDRE           : constant        := 12;
   Sig_USART_UDRE_String    : constant String := "__vector_12";
   --  USART, TX Complete
   Sig_USART_TX             : constant        := 13;
   Sig_USART_TX_String      : constant String := "__vector_13";
