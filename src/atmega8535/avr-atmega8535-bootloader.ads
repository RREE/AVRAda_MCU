...
package AVR.ATmega8535.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-atmega8535-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
   ...
   Boot_Info : constant Boot_Info_Array :=
     ( 1 => (Pages => 2, Start => 16#F80#) ,
       2 => (Pages => 4, Start => 16#F00#) ,
       3 => (Pages => 8, Start => 16#E00#) ,
       4 => (Pages => 16, Start => 16#C00#) );
   pragma Style_Checks (On);

end AVR.ATmega8535.Bootloader;
